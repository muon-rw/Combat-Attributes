...
public class MixinConfigPluginNeoforge implements IMixinConfigPlugin {
    ...
    private static final Logger LOGGER = LogManager.getLogger("Template-Mixin");

    @Override
    public void onLoad(String mixinPackage) {
        // To set these up, view the MixinSquared wiki:
        // https://github.com/Bawnorton/MixinSquared/wiki
        // MixinAnnotationAdjusterRegistrar.register(new TemplateMixinAdjuster());
        // MixinAnnotationAdjusterRegistrar.register(new TemplateMixinCanceller());
    }
